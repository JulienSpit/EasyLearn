	<div id="transition" class="row">
		...
		<div class="ui segment center aligned grid">
			<div class="three column row">
				<div class="column">
					<img class="ui small circular centered image" src="site/images/ben.jpg">
					<div class="ui header">
						Benjamin COULONVAL
					</div>
				</div>
				<div class="column">
					<img class="ui small circular centered image" src="site/images/jul.jpeg">
					<div class="ui header">
						Julien SPITALERI
					</div>
				</div>
				<div class="middle aligned column">
					<p><img class="ui mini spaced centered image" src="site/images/school.png"> Nous sommes deux alternants, réalisant dans le cadre d'un projet web, ce site de e-learning.</p>
				</div>
			</div>
		</div>
			<h1 class="ui header">
